...
domainSizes=[10000]#[1000,2000,4000,8000,16000,32000,64000,128000,256000] # domainsizes of less than 1000 so range(100,1000,100) 
selectivities=[0.001]#[0.04,0.05,0.06,0.07,0.08,0.09] #0.5
rangequery_ranges=[10]#[4,8,16,32,64,128]
retrieveExactly= ""#"10000"#"1,10,20,30,40,50,60" #1]#[30,40,50,60]#[10,20,30,40,50,60]
outdir="./results/parallelised-size:2^20cols:1,5-retrieveExactly:"+str(retrieveExactly)+"-BlockSize:0-UseGamma"+str(useGamma)
maxNumThreads=1
                        ...
                        for maxSelectivityValue in selectivities:
                            ...
                            for vs in valueSizes:
                                ...
                                for rangequeryrange in rangequery_ranges:
                                    ...
                                    oramLogCapacityString="--logcapacity "+str(oramLogCapacity)+" "
                                    ...
                                    normalDistributionString="--normalDistribution "+str(normalDistribution)+ " "
                                    ...
                                    command="./bin/main "\
                                                ...
                                                +useGammaString \
                                                +oramLogCapacityString \
                                                +valueSize\
                                                +seed\
                                                +normalDistributionString\
                                                +verbosityStr+outdirStr+fileLoggingStr #+retrieveExactlyString\
