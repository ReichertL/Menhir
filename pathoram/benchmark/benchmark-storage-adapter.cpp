...
namespace PathORAM
{
	...
	class StorageAdapterBenchmark : public ::benchmark::Fixture
	{
		...
		void Configure(TestingStorageAdapterType type, number cap)
		{
			CAPACITY=cap;
			switch (type)
			{
	...
	{
		Configure((TestingStorageAdapterType)state.range(0),state.range(2));
	...
	{
		b
			->Args({StorageAdapterTypeInMemory, 1,1000})
			->Args({StorageAdapterTypeInMemory, 3,1000})
			->Args({StorageAdapterTypeInMemory, 1,10000})
			->Args({StorageAdapterTypeInMemory, 3,10000})			
			->Args({StorageAdapterTypeInMemory, 1,100000})
			->Args({StorageAdapterTypeInMemory, 3,100000})		
			->Args({StorageAdapterTypeFileSystem, 1,1000})
			->Args({StorageAdapterTypeFileSystem, 3,1000})
			->Args({StorageAdapterTypeFileSystem, 1,10000})
			->Args({StorageAdapterTypeFileSystem, 3,10000})			
			->Args({StorageAdapterTypeFileSystem, 1,100000})
			->Args({StorageAdapterTypeFileSystem, 3,100000});					
